		...
		<div class="page-inner py-3">
			<div class="">
				...
				<div class="text-white">
					<h1 class="page-title text-white">Ajout Nouveau Droit</h1>
					<form method="POST" action="{{route('AjoutDroit')}}">
						@csrf
						<div class="row col-md-12">
							<div class="form-group col-md-4">
								<label class="text-white">Type de droit :</label>
								<input type="text" name="type" class="form-control" placeholder="Ajouter un droit" required="">
							</div>
							<div class="form-group col-md-4">
								<label class="text-white">montant :</label>
								<input type="number" name="montant" class="form-control" placeholder="Ajouter le montant" required="">
							</div>
							...
							<table  class="display table table-striped table-hover datatables">
								...
								<tbody class="text-center">
									...
									<tr>
										...
										<td>{{$droit->montant}}</td>
										<td>
											<a href="{{route('editDroit',$droit->id)}}" class="btn btn-info btn-sm ml-2"><i class="fas fa-edit"></i></a>
											<a href="{{route('supprimeDroit',$droit->id)}}" class="btn btn-danger btn-sm ml-3" onclick="return confirm('Voulez-vous bien la supprimer ?')"><i class="fas fa-trash"></i></a>
										</td>
									</tr>
									@endforeach
								</tbody>
